...
public class EndTurnDamageEnemyCreatures : CreatureEffect {

	public EndTurnDamageEnemyCreatures(Player owner, CreatureLogic creature, int specialAmount):base(owner, creature, specialAmount){
	}
